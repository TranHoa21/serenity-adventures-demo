...
const AboutUs = () => {
    return (
        <>
            <Head>
                <title>About Us | Serenity Adventures | Your Guide to Unforgettable Travel</title>
                <meta name="description" content="Discover Serenity Adventures, a leading travel planning agency dedicated to creating personalized, unforgettable journeys. Explore the wild world with our expert team and experience unique travel adventures tailored just for you." />
            </Head>
            <div className="row">
                <h1>About Us</h1>
