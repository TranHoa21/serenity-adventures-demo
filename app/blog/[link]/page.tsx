...
const TourDetail = () => {
    ...
    useEffect(() => {
        if (link) {
            axios.get<Post>(`https://sever-b483.onrender.com/api/v1/post/${link}`)
                .then(response => {
                    ...
                    axios.get(`https://sever-b483.onrender.com/api/v1/post/${postId}/like/${userId}`)
                        .then(response => {
                    ...
                    axios.get<Comment[]>(`https://sever-b483.onrender.com/api/v1/post/${postId}/comments`)
                        .then(response => {
            ...
            axios.get<User>(`https://sever-b483.onrender.com/api/v1/user/${userId}`)
                .then(response => {
    ...
    const handleCommentSubmit = (event: FormEvent, postId: number) => {
        ...
        axios.post(`https://sever-b483.onrender.com/api/v1/post/${postId}/comments/${userId}`, { content: newComment, userAvatar, userName, userId })
            .then(response => {
    ...
    const handleDeleteComment = (commentId: number) => {
        axios.delete(`https://sever-b483.onrender.com/api/v1/post/comments/${commentId}`)
            .then(response => {
    ...
    const handleUpdateComment = (commentId: number) => {
        axios.put(`https://sever-b483.onrender.com/api/v1/comments/${commentId}`)
            .then(response => {
    ...
    const handleLike = (event: React.MouseEvent<HTMLButtonElement>) => {
        ...
        if (liked) {
            axios
                .delete(`https://sever-b483.onrender.com/api/v1/post/${postId}/like/${userId}`)
                .then(response => {
            ...
            axios
                .post(`https://sever-b483.onrender.com/api/v1/post/${postId}/like/${userId}`, { postId, userId })
                .then(response => {
