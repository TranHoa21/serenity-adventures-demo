...
const Chooes = () => {
    return (
        <div className="w-c">
            <h1 className="w-c-title">Why choose us for travel?</h1>
            <div className="choo">
