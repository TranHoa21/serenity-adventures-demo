            ...
            <div className='rwanda-gorilla-container'>
                <div className='rwanda-gorilla row'>
                    <div className='col-md-10 col-sm-10'>
                        <h3><strong>Things To Do When You Visit Uganda For a Honey Moon</strong></h3>
                        <h3><strong>Bwindi Impenetrable National Park Safaris</strong></h3>
                        ...
                        <h3><strong>Queen Elizabeth National Park Safaris</strong></h3>
                        ...
                        <h3><strong>Chimpanzee Tracking Uganda Safari</strong></h3>
                        <p>Chimpanzee tracking is a very fascinating experience. Prepare today and set out to Uganda’s natural jungles as you spend a number of hours tracking these impressive creatures.</p>
                        <p>You will be allowed to spend some time as you observe them swing from one tree to another, feed, play about or progress speedily on the ground right in front of you.</p>
                        <p>Where to do it from From the Kibale Forest National Park to Budongo Forest, Mgahinga Gorilla National Park, Bwindi Impenetrable, Ngamba Island Chimpanzee sanctuary and Kyambura Gorge; your trip shall be an enormous encounter of these primates.</p>
                        ...
                        <p>Where to do this Queen Elizabeth National Park Mgahinga Gorilla National Park Bwindi Impenetrable forest Kibale Forest National Park Budongo Forest Reserve.</p>
                    </div>
