...
const Destination = () => {
    return (
        <>
            <Head>
                <title>Explore Tanzania - Safaris, Kilimanjaro, and Tropical Islands | Serenity Adventure</title>
                <meta name="description" content="Discover Tanzania's stunning landscapes and diverse wildlife. Experience the Serengeti's Big Five, climb Mount Kilimanjaro, and relax on Zanzibar's tropical beaches. Book your adventure with Serenity Adventure today!" />
            </Head>
